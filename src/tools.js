...
import { ANALYSIS_SYSTEM_PROMPT, COMPARISON_SYSTEM_PROMPT, DISTILLATION_SYSTEM_PROMPT, generateUserPrompt, } from "./prompts.js";
 ...
 */
export async function scanForFallacies(text) {
 ...
 */
export async function compareSources(sourceA, sourceB) {
 ...
 */
export async function distillKernel(text) {
